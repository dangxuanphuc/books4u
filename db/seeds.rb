...
Publisher.create!([
  ...
  {name: "Prima Games", description: "Vietnam's publisher"},
  {name: "Springer", description: "Vietnam's publisher"},
  {name: "KADOKAWA/アスキー・メディアワークス", description: "Vietnam's publisher"},
  {name: "McGraw-Hill Education", description: "Vietnam's publisher"},
  {name: "For Dummies", description: "Vietnam's publisher"}
])
...
Author.create!([
  ...
  {name: "aolo Perrotta",
    description: "aolo Perrottaは、ソフトウェアの設計・開発に10
    年以上携わっており、
  ...
  {name: "Sebastian Raschka",
    description: "Sebastian Raschka著者ページについて
...
AuthorBook.create!([
  ...
  {author_id: 3, book_id: 14},
  {author_id: 1, book_id: 15}
])
